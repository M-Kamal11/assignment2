...
<head>
   ...
   <style>@import url('https://fonts.googleapis.com/css?family=Montserrat:400,800');</style>
   <style>
* {
...
<body>
    ...
    <h2>Enter The World of MK Fitness!</h2>
    <div class="container" id="container">
        ...
        <div class="form-container sign-in-container">
            ...
            <form action="/login" required method="post">
                @csrf
                <h1>Sign in</h1>
                <div class="social-container">
                    <a href="#" class="social"><i class="fab fa-facebook-f"></i></a>
...
<script>/*jquery function to make IDs constant*/
